<?php /*a:13:{s:66:"D:\PHPTutorial\WWW\shop\application\admin\view\goods\addgoods.html";i:1540912848;s:61:"D:\PHPTutorial\WWW\shop\application\admin\view\base\body.html";i:1542012909;s:61:"D:\PHPTutorial\WWW\shop\application\admin\view\base\head.html";i:1542014107;s:76:"D:\PHPTutorial\WWW\shop\application\admin\view\goods\addgoods\alone_css.html";i:1540912812;s:63:"D:\PHPTutorial\WWW\shop\application\admin\view\base\header.html";i:1541833621;s:61:"D:\PHPTutorial\WWW\shop\application\admin\view\base\left.html";i:1541834580;s:66:"D:\PHPTutorial\WWW\shop\application\admin\view\base\ncsc_path.html";i:1539702082;s:64:"D:\PHPTutorial\WWW\shop\application\admin\view\base\tabmenu.html";i:1541655445;s:77:"D:\PHPTutorial\WWW\shop\application\admin\view\goods\addgoods\right_mian.html";i:1541087938;s:61:"D:\PHPTutorial\WWW\shop\application\admin\view\base\page.html";i:1541655430;s:65:"D:\PHPTutorial\WWW\shop\application\admin\view\base\password.html";i:1541655439;s:75:"D:\PHPTutorial\WWW\shop\application\admin\view\goods\addgoods\alone_js.html";i:1540912824;s:68:"D:\PHPTutorial\WWW\shop\application\admin\view\base\common_base.html";i:1542012759;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
      <!-- 公共头部 -->
...
<script>
	...
	<!-- 编辑商品时，用到的JS、CSS资源 -->
<!-- 编辑商品，公共CSS、JS文件引用 -->
<link rel="stylesheet" type="text/css" href="__PUBLIC__/static/css/product.css">
<!-- 选择商品图，弹出框的样式 -->
<link rel="stylesheet" type="text/css" href="__PUBLIC__/static/css/defau.css">
<link href="__PUBLIC__/static/css/jquery.ui.css" type="text/css" rel="stylesheet">
<link href="__PUBLIC__/static/css/goods_create.css" type="text/css" rel="stylesheet">
<link href="__PUBLIC__/static/css/base.css" type="text/css" rel="stylesheet">
<link href='__PUBLIC__/static/css/jquery.gridly.css' rel='stylesheet' type='text/css'>
<link href='__PUBLIC__/static/css/sample.css' rel='stylesheet' type='text/css'>
<link href='__PUBLIC__/static/css/select_category_next.css' rel='stylesheet' type='text/css'>
<link href="__PUBLIC__/static/css/editgoods.css" rel="stylesheet" type="text/css">
<script type="text/javascript" charset="utf-8" src="__PUBLIC__/static/js/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="__PUBLIC__/static/js/ueditor.all.js"></script>
<!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
<!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
<script type="text/javascript" charset="utf-8" src="__PUBLIC__/static/js/zh-cn.js"></script>
<script src="__PUBLIC__/static/js/ajax_file_upload.js" type="text/javascript"></script>
<script src="__PUBLIC__/static/js/image_common.js" type="text/javascript"></script>
<script src="__PUBLIC__/static/js/kindeditor-min.js" type="text/javascript"></script>
<!--  用  验证商品输入信息-->
<script src="__PUBLIC__/static/js/jscommon.js" type="text/javascript"></script>
<!-- 用 ，加载数据-->
<script src="__PUBLIC__/static/js/art_dialog.source.js"></script>
<script src="__PUBLIC__/static/js/iframe_tools.source.js"></script>
<!-- 我的图片 -->
<script src="__PUBLIC__/static/js/material_managedialog.js"></script>
<script src="__PUBLIC__/static/js/ajax_file_upload.js" type="text/javascript"></script>
<script src="__PUBLIC__/static/js/file_upload.js" type="text/javascript"></script>
<script src='__PUBLIC__/static/js/init_address.js'></script>
<script src="__PUBLIC__/static/js/release_good_second.js"></script>
<script type="text/javascript" src="__PUBLIC__/static/js/goods_sku_create.js"></script>
<script type="text/javascript" src="__PUBLIC__/static/js/jquery.totop.min.js"></script>
<style>
  .category-text {
...
<hr class="tabmenu_hr" style="border:1px solid #00C0FF;margin:0 0px 10px 20px;" />
  ...
  <div class="ncsc-form-goods">
            ...
            <div class="goodspic-uplaod" style="padding: 15px;">
              <div class='img-box' style="min-height:160px;">
                <div class="upload-thumb" id="default_uploadimg">
                  <img src="__PUBLIC__/static/picture/default_goods_image_240.gif">
                </div>
              </div>
              <div class="clear"></div>
    ...
    <script src="__PUBLIC__/static/js/drag-arrange.js" type="text/javascript" charset="utf-8"></script>
    <script src="__PUBLIC__/static/js/ajax_file_upload.js" type="text/javascript"></script>
    <script type="text/javascript" src="__PUBLIC__/static/js/jquery.ui.widget.js" charset="utf-8"></script>
    <script type="text/javascript" src="__PUBLIC__/static/js/jquery.fileupload.js" charset="utf-8"></script>
    ...
    <script type="text/javascript">
      ...
      $(function() {
        ...
        $('#fileupload').fileupload({
          url: '<?php echo url("admin/upload/photoalbumupload"); ?>',
          dataType: 'json',
          formData: dataAlbum,
          add: function(e, data) {
            ...
            $.each(data.files, function(index, file) {
              ...
              html += '<img nstype="goods_image" src="/shop/upload/goods/uoload_ing.gif">';
              // tml += `<img nstype="goods_image" src = '/shop/upload/goods/${file.name}'>`;
            ...
            console.log(param);
            $this = $('#goods_picture_box div[nstype="' + param.data.origin_file_name + '"]');
            if (param.code > 0) {
              $this.removeAttr("nstype");
              $this.children("img").attr("src", "/shop/" + param.data.file_name);
              $this.children("input[type='hidden']").val(param.data.file_id);
            } else {
              $this.remove();
        ...
        $(".off-box").live('click', function() {
          if ($(".img-box .upload-thumb").length == 1) {
            ...
            html += '<img nstype="goods_image" src="__PUBLIC__/static/picture/default_goods_image_240.gif">';
        ...
        $(obj).fileupload({
          ...
          add: function(e, data) {
            ...
            $.each(data.files, function(index, file) {
              ...
              html += '<img nstype="goods_image" src="__PUBLIC__/static/picture/uoload_ing.gif">';
              html +=
  ...
  <div class="btn-submit">
    <button class="btn btn-info" id="btnSave" type="button" onClick="SubmitProductInfo(0,'http://tp.23673.com/admin','http://tp.23673.com')">保存</button>
    <button class="btn btn-info" id="btnSave2" type="button" onClick="SubmitProductInfo(1,'http://tp.23673.com/admin','http://tp.23673.com')">保存并预览</button>
  </div>
  <div id="fixedNavBar">
    <h3>页面导航</h3>
    <ul>
  ...
  <script type='text/javascript' src='__PUBLIC__/static/js/sample.js'></script>
    ...
    function PopUpCallBack(id, src) {
      ...
      switch (speciFicationsFlag) {
        case 0:
          ...
          if (srcArr.length >= 1) {
            ...
            for (var i = 0; i < srcArr.length; i++) {
              ...
              html += '<img  src="__PUBLIC__/static/picture/4c8cd98331444ab991bcbef3735b7e2d.gif' + srcArr[i] + '">';
        ...
        case 1:
          //商品详情
          for (var i = 0; i < srcArr.length; i++) {
            var description = "<img src='__PUBLIC__/static/picture/4c8cd98331444ab991bcbef3735b7e2d.gif" + srcArr[i] + "' />";
...
<script>
  var platform_shopname = '六星开源商城';
	...
	<script type="text/javascript" src="__PUBLIC__/static/js/jquery-ui-private.js" charset="utf-8"></script>
<script type="text/javascript" src="__PUBLIC__/static/js/jquery.timers.js"></script>
<div id="dialog"></div>
<script type="text/javascript">
