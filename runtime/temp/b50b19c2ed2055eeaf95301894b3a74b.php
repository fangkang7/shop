...
<script>
	...
	<link rel="stylesheet" type="text/css" href="/shop/public//static/css/dashboard.css">
<link rel="stylesheet" type="text/css" href="/shop/public//static/css/index.css">
<script src="/shop/public//static/js/highcharts.js"></script>
<script src="/shop/public//static/js/exporting.js"></script>
<script>
  var admin_main = "http://tp.23673.com/admin";
</script>
<script src="/shop/public//static/js/index.js"></script>
<script src="/shop/public//static/js/jquery.timers.js"></script>
 <!-- 引入单独的css样式 -->
...
<hr class="tabmenu_hr" style="border:1px solid #00C0FF;margin:0 0px 10px 20px;" />
  ...
  <header class="home">
    <article>
      <div class="home-shop">
        <img src="../../static/picture/六星开源商城_home.png" /> <span><a href="http://tp.23673.com/admin/config/webconfig">网站设置</a></span>
      </div>
      <div class="home-info">
  ...
  <div class="goods-prompt">
    ...
    <div class="subtitle">
      <img src="../../static/picture/green_giftbag.png" /> <label>店铺商品发布情况：<span class="goods_all_count">0/不限</span></label>
      <img src="../../static/picture/orange_picture.png" /><label>图片空间使用情况：<span>不限</span></label>
    </div>
    <div class="goods-state">
      <ul>
        <a href="http://tp.23673.com/admin/goods/goodslist">
          <li>
            <h4 class="goods_sale_count">0</h4>出售中
          </li>
        </a>
        <a href="http://tp.23673.com/admin/goods/goodslist">
          <li>
            <h4 class="goods_audit_count">0</h4>仓库中
          </li>
        </a>
        <a href="http://tp.23673.com/admin/goods/goodslist">
          <li>
            <h4 class="goods_shelf_count">0</h4>违规下架
          </li>
        </a>
        <a href="http://tp.23673.com/admin/saleservice/consultlist?type=to_reply">
          <li>
            <h4 class="goods_consult_count">0</h4>待回复咨询
          </li>
        </a>
      </ul>
    </div>
  ...
  <div class="merchants-help">
    <h3>商家帮助及平台联系方式</h3>
    <div class="subtitle">
      <img src="../../static/picture/green_phone.png" /><label>电话：<span id="user_tel">0731-85573019</span></label>
      <img src="../../static/picture/orange_email.png" /><label>邮箱：<span id="user_email">10202706@qq.com</span></label>
    </div>
  ...
  <div class="goods-prompt">
    ...
    <div class="subtitle">
      <img src="../../static/picture/green_list.png" /><label>近期售出：<span>交易中的订单</span></label>
      <img src="../../static/picture/orange_shield.png" /><label>维权投诉：<span>收到维权投诉</span></label>
    </div>
    <div class="goods-state">
      <ul>
        <a href='http://tp.23673.com/admin/order/orderlist?status=0'>
          <li>
            <h4 class="daifukuan">0</h4>待付款
          </li>
        </a>
        <a href='http://tp.23673.com/admin/order/orderlist?status=1'>
          <li>
            <h4 class="daifahuo">0</h4>待发货
          </li>
        </a>
        <a href='http://tp.23673.com/admin/order/orderlist?status=2'>
          <li>
            <h4 class="yifahuo">0</h4>已发货
          </li>
        </a>
        <a href='http://tp.23673.com/admin/order/orderlist?status=3'>
          <li>
            <h4 class="yishouhuo">0</h4>已收货
          </li>
        </a>
        <a href='http://tp.23673.com/admin/order/orderlist?status=4'>
          <li>
            <h4 class="yiwancheng">0</h4>已完成
          </li>
        </a>
        <a href='http://tp.23673.com/admin/order/orderlist?status=5'>
          <li>
            <h4 class="yiguanbi">0</h4>已关闭
          </li>
        </a>
        <a href='http://tp.23673.com/admin/order/orderlist?status=-1'>
          <li>
            <h4 class="tuikuanzhong">0</h4>退款中
          </li>
        </a>
        <a href='http://tp.23673.com/admin/order/orderlist?status=-2' style="display: none;">
          <li>
            <h4 class="yituikuan">0</h4>已退款
          </li>
        </a>
      </ul>
    </div>
  ...
  <div class="operation-promote">
    ...
    <div class="operation-promote-state">
      <ul>
        <li class="snapup"><img src="../../static/picture/promoote_snapup.png" class="promote-img" />
          <h5 class="promote-h5">
            抢购活动<span>已开通</span>
          </h5>
          <p class="promote-p">参与平台发起的抢购活动提搞商品成交量及店铺浏览量</p>
        </li>
        <li class=time-limit><img src="../../static/picture/promoote_snapup.png" class="promote-img" />
          <h5 class="promote-h5">
            限时折扣<span>已开通</span>
          </h5>
        ...
        <li class=full_present><img src="../../static/picture/promoote_snapup.png" class="promote-img" />
          <h5 class="promote-h5">
            满即送<span>已开通</span>
          </h5>
          <p class="promote-p">商家自定义满即送标准与规则，促进购买转化率</p>
        </li>
        <li class=preferential-suit><img src="../../static/picture/promoote_snapup.png" class="promote-img" />
          <h5 class="promote-h5">
            优惠套装<span>未开通</span>
          </h5>
          <p class="promote-p">商品优惠套装，多重搭配更多实惠、商家必备营销方式</p>
        </li>
        <li class=recommended_booth><img src="../../static/picture/promoote_snapup.png" class="promote-img" />
          <h5 class="promote-h5">
            推荐展位<span>未开通</span>
          </h5>
          <p class="promote-p">选择商品参与平台发布的主题活动，审核后集中展示</p>
        </li>
        <li class=kims_volume><img src="../../static/picture/promoote_snapup.png" class="promote-img" />
          <h5 class="promote-h5">
            代金券<span>已开通</span>
          </h5>
...
<script>
  var platform_shopname = '六星开源商城';
	...
	<script type="text/javascript" src="/shop/public//static/js/jquery-ui-private.js" charset="utf-8"></script>
<script type="text/javascript" src="/shop/public//static/js/jquery.timers.js"></script>
<div id="dialog"></div>
