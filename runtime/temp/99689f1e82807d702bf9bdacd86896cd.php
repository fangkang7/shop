<?php /*a:13:{s:67:"D:\PHPTutorial\WWW\shop\application\admin\view\goods\goodslist.html";i:1540886524;s:61:"D:\PHPTutorial\WWW\shop\application\admin\view\base\body.html";i:1542012909;s:61:"D:\PHPTutorial\WWW\shop\application\admin\view\base\head.html";i:1542014107;s:77:"D:\PHPTutorial\WWW\shop\application\admin\view\goods\goodslist\alone_css.html";i:1540734444;s:63:"D:\PHPTutorial\WWW\shop\application\admin\view\base\header.html";i:1541833621;s:61:"D:\PHPTutorial\WWW\shop\application\admin\view\base\left.html";i:1541834580;s:66:"D:\PHPTutorial\WWW\shop\application\admin\view\base\ncsc_path.html";i:1539702082;s:81:"D:\PHPTutorial\WWW\shop\application\admin\view\goods\goodslist\right_tabmenu.html";i:1540886336;s:78:"D:\PHPTutorial\WWW\shop\application\admin\view\goods\goodslist\right_mian.html";i:1540886592;s:61:"D:\PHPTutorial\WWW\shop\application\admin\view\base\page.html";i:1541655430;s:65:"D:\PHPTutorial\WWW\shop\application\admin\view\base\password.html";i:1541655439;s:76:"D:\PHPTutorial\WWW\shop\application\admin\view\goods\goodslist\alone_js.html";i:1542087392;s:68:"D:\PHPTutorial\WWW\shop\application\admin\view\base\common_base.html";i:1542012759;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
      <!-- 公共头部 -->
...
<script type="text/javascript" src="__PUBLIC__/static/js/wdatepicker.js"></script>
<style type="text/css">
  .tr-title {
    height: 30px;
    background: #E3E3E3;
...
<div class="LEFT">
  ...
  <a href="javascript:;">欢迎页</a>
	...
	<div class="tabmenu">
  <ul class="tab pngFix">
    <li class="active"><a href="http://tp.23673.com/admin/goods/goodslist">商品列表</a></li>
  </ul>
  <div class="right_side_operation">
    <ul>
      <li><a class="nscs-table-handle_green" href="http://tp.23673.com/admin/goods/addgoods"><i class="fa fa-plus-circle"></i>&nbsp;发布商品</a></li>
    </ul>
  </div>
</div>
    ...
    <tr>
      <th style="line-height:33px;">
        ...
        <div class="goodsCategory one">
          <ul>
            <li class="js-category-one" category_id="311">女装/男装/内衣 <i class="fa fa-angle-right fa-lg"></i>
            </li>
            <li class="js-category-one" category_id="312">鞋靴/箱包/配件 </li>
            <li class="js-category-one" category_id="315">手机数码 </li>
            <li class="js-category-one" category_id="317">家用电器 <i class="fa fa-angle-right fa-lg"></i>
            </li>
          </ul>
        </div>
    ...
    <div class="tab-pane active">
      <table class="table table-striped table-main" border="0">
        ...
        <label class='checkbox-inline' style='display:inline-block;' >
          <input type='checkbox' value='107'><b> 女装</b>&nbsp;&nbsp;&nbsp;
        </label>
                      <label style='display:inline-block;'>
          <input type='checkbox' value='108'>连衣裙								</label>
                        </p>

        <p>
        <label class='checkbox-inline' style='display:inline-block;' >
          <input type='checkbox' value='109'><b>男装</b>&nbsp;&nbsp;&nbsp;
        </label>
                      </p>

        <p>
        <label class='checkbox-inline' style='display:inline-block;' >
          <input type='checkbox' value='110'><b>平板</b>&nbsp;&nbsp;&nbsp;
        </label>
                      </p>

        <p>
        <label class='checkbox-inline' style='display:inline-block;' >
          <input type='checkbox' value='111'><b>分组添加测试</b>&nbsp;&nbsp;&nbsp;
        </label>
                      </p>

        <p>
        <label class='checkbox-inline' style='display:inline-block;' >
          <input type='checkbox' value='112'><b>手机</b>&nbsp;&nbsp;&nbsp;
        </label>
                      </p>

        <p>
        <label class='checkbox-inline' style='display:inline-block;' >
          <input type='checkbox' value='113'><b>电器</b>&nbsp;&nbsp;&nbsp;
        </label>
                      </p>
                      </div>
...
<script type="text/javascript">
  ...
  function LoadingInfo(page_index) {
    ...
    $.ajax({
      type: "post",
      url: "<?php echo URL('admin/goods/goodslist'); ?>",
      data: {
      ...
      success: function(data) {
        ...
        if (data["data"].length > 0) {
          for (var i = 0; i < data["data"].length; i++) {
            ...
            html += '<div class="QRcode" style="display: none; position: absolute;width:110px;top:28px;left:15px"id="qrcode"><p><img src="/shop/' + data["data"][i]["QRcode"] +
            ...
            html += '<tr><td colspan="2" style="background: white;"><div><a class="a-pro-view-img" href="http://tp.23673.com/goods/goodsinfo?goodsid=' + data["data"][i]["goods_id"] +
              '" target="_blank"><img class="thumbnail-img"src="/shop/' + data["data"][i]['album']["pic_cover_micro"] + '">';
  ...
  */
  function batchUpdateGoodsQrcode() {
    ...
    $.ajax({
      type: "post",
      url: "<?php echo URL('admin/goods/updategoodsqrcode'); ?>",
      data: {
        "goods_id": goods_ids, // array
      },
      success: function(data) {
        if (data["code"] > 0) {
